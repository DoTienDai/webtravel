...
<div class="container box-container-tour">
         <div class="row">
            <ul class="breadcrumb">
               ...
               <li><a href="">Du lịch trong nước <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
               <li class="active"><a href="">Du lịch Quy Nhơn Phú Yên</a></li>
            </ul>
         </div>
      </div>
      <div class="container box-container-tour">
            ...
            <div class="col-md-8 col-xs-12">
                        ...
                        <div class="col-md-12 col-xs-12">
                           <div class="w100 fl bimg-dt-left">
                              <div class="box-wap-imgpr-dt">
                                 <img alt="du lịch" src="{{asset('fontend/imgs/logo-ghenh-da-dia.jpg')}}" width="100%">
                  ...
                  <div class="b-detail-ct-tour w100 fl top-20">
                     ...
                     <div class="tab-content">
                        <div id="home" class="tab-pane fade in active">
                           ...
                           <p style="text-align:justify"><span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif"><em><img alt="" src="{{asset('fontend/imgs/du-lich-quy-nhon-kham-pha-khu-da-ngoai-trung-luong-noi-duoc-vi-von-la-dao-jeju-phien-ban-viet-nam.jpg')}}" style="height:500px; width:1100px" /></em></span></span></p>
                           <hr />
                           ...
                           <hr />
                           <p style="text-align:justify"><span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif"><img alt="" src="{{asset('fontend/imgs/canh-dong-chong-chong.jpg')}}" style="height:550px; width:1100px" /></span></span></p>
                           <hr />
                           ...
                           <hr />
                           <p style="text-align:justify"><span style="color:#008000"><span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif"><strong><img alt="" src="{{asset('fontend/imgs/ghenh_da_dia_1.jpg')}}" style="height:600px; width:1100px" /></strong></span></span></span></p>
                           <hr />
                           ...
                           <p style="text-align:justify"><span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif"><img alt="" src="{{asset('fontend/imgs/den-Quy-Nhon-kham-pha-cung-duong-di-bo-ven-bien-dep-bac-nhat.jpg')}}" style="height:550px; width:1100px" /></span></span></p>
                           <div class="w100 fl">
                              <div class="row">
                                 <div class="col-xs-12 col-md-6">
                                    <div class="tit-service-attach">Giá dịch vụ bao gồm</div>
                                    <ul class="ul-lst-service-attach">
                                       <li><img alt="du lịch" src="{{asset('fontend/imgs/bao-hiem.png')}}"> Bảo hiểm du lịch theo quy định</li>
                                       <li><img alt="du lịch" src="{{asset('fontend/imgs/bua-an.png')}}"> Các bữa ăn theo chương trình</li>
                                       <li><img alt="du lịch" src="{{asset('fontend/imgs/huong-dan-vien.png')}}"> Hướng dẫn viên suốt chương trình</li>
                                       <li><img alt="du lịch" src="{{asset('fontend/imgs/ve-tham-quan.png')}}"> Vé tham quan theo chương trình</li>
                                       <li><img alt="du lịch" src="{{asset('fontend/imgs/van-chuyen.png')}}"> Các loại hình vận chuyển theo chương trình</li>
                                    </ul>
                                 </div>
                                 <div class="col-xs-12 col-md-6">
                                    <div class="tit-service-attach">Giá dịch vụ không bao gồm</div>
                                    <ul class="ul-lst-service-attach">
                                       <li><img alt="du lịch" src="{{asset('fontend/imgs/ho-chieu.png')}}"> Chứng minh thư, hộ chiếu còn hiệu lực 6 tháng</li>
                                       <li><img alt="du lịch" src="{{asset('fontend/imgs/images/hanh-ly.png')}}"> Phí hành lý quá cước và các chi phí cá nhân</li>
                                       <li><img alt="du lịch" src="{{asset('fontend/imgs/ho-chieu.png')}}"> Visa tái nhập cho người nước ngoài(nếu có)</li>
                                       <li><img alt="du lịch" src="{{asset('fontend/imgs/money.png')}}"> Tiền Tip cho hướng dẫn viên địa phương</li>
                                    </ul>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="lichtrinhtour-show">
                              <table class="table table-bordered">
                                 ...
                                 <tr class="">
                                    ...
                                    <td class="thtd-destination"><a class="aclassify-tour" href="" target="_blank">Tour Hot nhất Hè 2023 Quy Nhơn - Phú Yên (Xứ Nẫu đẹp nhất Việt Nam)</a></td>
                                    <td>3</td>
                                    <td>
                                       Hàng ngày									
                                    </td>
               ...
               <div class="row">
                  <div class="col-xs-12">
                     ...
                     <div class="heateor_sss_sharing_container heateor_sss_horizontal_sharing" heateor-sss-data-href="">
                        <div class="heateor_sss_sharing_title" style="font-weight:bold">Chia sẻ bài viết lên mạng xã hội</div>
                        <ul class="heateor_sss_sharing_ul">
                           <a target="_blank" href="&amp;url=-&amp;via=TWITTER-HANDLER">
                           ...
                           <a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&amp;url=&amp;title=et-set-nam.html&amp;source=ml">
                              <li class="heateorSssSharingRound">
                           ...
                           <a target="_blank" href="https://mix.com/mixit?url=">
                              <li class="heateorSssSharingRound">
                           ...
                           <li class="heateorSssSharingRound">
                              <i style="width:35px;height:35px;border-radius:999px;" alt="Whatsapp" title="Whatsapp" class="heateorSssSharing heateorSssWhatsappBackground">
                                 <a href="https://web.whatsapp.com/send?text=" rel="nofollow noopener" target="_blank">
                     ...
                     <div style="width:100%; overflow:hidden">
                        <div style="float: left;margin-right: 5px; position: relative; z-index: 1001; line-height: 33px">
                           <div class="fb-like" data-href="" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false" data-colorscheme="dark"></div>
                        </div>
                        <div style="float: left;margin-right: 5px; position: relative; z-index: 1001; line-height: 33px">
            ...
            <div class="col-md-4 col-xs-12 bx-right-bar">
               <div class="box-support-right">
                  <div class="support-center">
                     ...
                     <ul>
                        <li>
                           <div class="lisup1"><span class="namesup">Mrs. : </span><span class="phonesup"></span></div>
                           <div class="blisup2">
                              <a href="#" class="zalo-icon"><img src="" alt="a"></a>
                              <a href="skype:6?chat" class="skype-icon"><img src="" alt="a"></a>
                              <a href="tel:(0913) 073 - 026" class="call-icon"><img src="" alt="a"></a>
                           </div>
                        </li>
                        <li>
                           <div class="lisup1"><span class="namesup">Miss. : </span><span class="phonesup">(098) 444</span></div>
                           <div class="blisup2">
                              <a href="#0984441944" class="zalo-icon"><img src="" alt="a"></a>
                              <a href="skype:3?chat" class="skype-icon"><img src="" alt="a"></a>
                              <a href="tel:(09" class="call-icon"><img src="" alt="a"></a>
                           </div>
                        </li>
                        <li>
                           <div class="lisup1"><span class="namesup">Miss. : </span><span class="phonesup"></span></div>
                           <div class="blisup2">
                              <a href="#0904577548" class="zalo-icon"><img src="" alt="a"></a>
                              <a href="skype:?chat" class="skype-icon"><img src="" alt="a"></a>
                              <a href="tel:(0904)" class="call-icon"><img src="" alt="a"></a>
                           </div>
                        </li>
                     </ul>
                  </div>
               ...
               <div class="w100 fl top-15 box-cldl">
                  ...
                  <ul class="ul-lst-article-bar">
                     <li><a href="">10 điểm đến được người Việt yêu thích nhất trong năm 2018</a></li>
                     <li><a href="">5 điểm du lịch nước ngoài giá cả hợp lý dành cho người Việt Nam</a></li>
                     <li><a href="">Những điều cần biết trước khi du lịch đến Sri Lanka</a></li>
                     <li><a href="">Những điều lưu ý khi đi du lịch Nhật Bản</a></li>
                     <li><a href="">Cẩm nang đi du lịch Đà Nẵng tất tần tật từ A -> Z vô cùng rẻ</a></li>
                     <li><a href="">Cẩm nang du lịch Thái Lan – Những điều bạn cần biết</a></li>
                     <li><a href="">Cẩm nang du lịch Bhutan – Những điều quan trọng nhất định phải biết</a></li>
                     <li><a href="">Cẩm nang cho chuyến du lịch Phú Quốc - Hòn đảo thiên đường giữa lòng biển xanh</a></li>
                     <li><a href="">Nét độc đáo của làng chài cá trích, Phú Quốc</a></li>
                     <li><a href="">Khám phá thiên nhiên tươi đẹp ở Gò Găng – TP. Vũng Tàu</a></li>
                  </ul>
               </div>
                        ...
                        <div class="w100 fl bx-wap-pr-item" style="height: 440px;">
                           <div class="clearfix box-wap-imgpr">
                              <a href="">
                                 ...
                                 <img src="{{asset('fontend/imgs/merry-christmas-1.png')}}" class="img-event-giang-sinh">                <!--<img src="/public/media/images/logo/logo-ghim-anh.jpg" class="img-ghim-anh">-->
                              </a>
                           </div>
                           <div class="clear"></div>
                           <h4><a href="">Tour 4 ngày 3 đêm đi hết 20 địa điểm “Hot” nhất tại Quy Nhơn – Phú Yên</a></h4>
                           <div class="clear"></div>
                           ...
                           <div class="group-book w100 fl">
                              ...
                              <a href="" class="link-book">Xem chi tiết</a>
                           </div>
                        </div>
                     </li>
                     <li>
                        <div class="w100 fl bx-wap-pr-item" style="height: 440px;">
                           ...
                           <div class="clear"></div>
                           <h4><a href="">Tour Hot nhất Hè 2023 Quy Nhơn - Phú Yên (Xứ Nẫu đẹp nhất Việt Nam)</a></h4>
                           <div class="clear"></div>
                           <div class="group-calendar w100 fl">
                              <div class="col-md-6 col-xs-7 date-start">
                                 <span class="lst-icon1"><i class="fa fa-calendar"></i> </span>
                        ...
                        <div class="w100 fl bx-wap-pr-item" style="height: 440px;">
                           <div class="clearfix box-wap-imgpr">
                              <a href="">
                                 ...
                                 <img src="{{asset('fontend/imgs/tet.png')}}" class="img-event-tour-tet"><img src="{{asset('fontend/imgs/new-icon.png')}}" class="img-event-moi">                <!--<img src="/public/media/images/logo/logo-ghim-anh.jpg" class="img-ghim-anh">-->
                              </a>
                           </div>
                           <div class="clear"></div>
                           <h4><a href="">Du lịch Quy Nhơn - Phú Yên Tour trọn gói, đặc sắc nhất</a></h4>
                           <div class="clear"></div>
                           <div class="group-calendar w100 fl">
                              <div class="col-md-6 col-xs-7 date-start">
                                 <span class="lst-icon1"><i class="fa fa-calendar"></i> </span>
                        ...
                        <div class="w100 fl bx-wap-pr-item" style="height: 440px;">
                           <div class="clearfix box-wap-imgpr">
                              <a href="">
                                 ...
                                 <img src="{{asset('fontend/imgs/merry-christmas-1.png')}}" class="img-event-giang-sinh"><img src="{{asset('fontend/imgs/new-icon.png')}}" class="img-event-moi">                <!--<img src="/public/media/images/logo/logo-ghim-anh.jpg" class="img-ghim-anh">-->
                              </a>
                           </div>
                           <div class="clear"></div>
                           <h4><a href="">Tour Du lịch Quy nhơn 3 ngày trọn gói, đặc sắc nhất</a></h4>
                           <div class="clear"></div>
                           <div class="group-calendar w100 fl">
                              <div class="col-md-6 col-xs-7 date-start">
                                 <span class="lst-icon1"><i class="fa fa-calendar"></i> </span>
