      ...
      <div class="row">
        <div class="col-md-12 col-xs-12 bx-title-lst-tour text-center">
          <div class="w100 fl title-tour1">
            <h2 style="color: #ffc700;font-size: 30px;"><img src="" alt="icon" style="width: 80px;"> Danh muc Tour Giá Sốc</h2>
          </div>
          ...
          <div class="row">
            <div class="col-md-4 col-xs-12 lst-tour-item">
               <div class="w100 fl bx-wap-pr-item">
                 ...
                 <div class="clear"></div>
                 <h4><a href="{{route('tour', ['du-lich-gia-soc'])}}">Tour Hot nhất Hè 2023 Quy Nhơn - Phú Yên (Xứ Nẫu
            ...
            <div class="col-md-4 col-xs-12 lst-tour-item">
               <div class="w100 fl bx-wap-pr-item">
                 ...
                 <div class="clear"></div>
                 <h4><a href="{{ route('tour', ['du-lich-noi-dia']) }}">Tour Hot nhất Hè 2023 Quy Nhơn - Phú Yên (Xứ Nẫu
                     đẹp nhất Việt Nam)</a></h4>
                 <div class="clear"></div>
                 <div class="group-calendar w100 fl">
                   <div class="col-md-6 col-xs-7 date-start">
          ...
          <div class="row">
            <div class="col-md-4 col-xs-12 lst-tour-item">
               <div class="w100 fl bx-wap-pr-item">
                 ...
                 <div class="clear"></div>
                 <h4><a href="{{ route('tour', ['du-lich-quoc-te']) }}">Tour Du lịch Singapore Malaysia 4 ngày 3 Đêm giá
          ...
          <div class="row">
            <div class="col-md-4 col-xs-12 lst-tour-item">
               <div class="w100 fl bx-wap-pr-item">
                 ...
                 <div class="clear"></div>
                 <h4><a href="{{route('tour', ['du-lich-noi-dia'])}}">Tour độc lạ, trọn gói: Hà Nội - Hà Giang - Lũng Cú
